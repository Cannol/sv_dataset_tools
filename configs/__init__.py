...
# VIDEO_TARGET_SELECTOR_CONFIG_FILE = file_exists(os.path.join(CONFIGS_DIR, 'dataset_for_each', 'video_target_selector.yaml'))
VIDEO_TARGET_SELECTOR_CONFIG_FILE = file_exists(os.path.join(CONFIGS_DIR, 'dataset_for_each', '18.yaml'))
